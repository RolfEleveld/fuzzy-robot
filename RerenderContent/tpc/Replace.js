...
// names and images
var look = {
        font:'"SourceSansProLight",Helvetica,Arial,sans-serif;',
        icon:'http://www.tpc.ch/favicon.ico',
        logo:'http://www.tpc.ch/site/images/tpc/logo.png',
        accents: '#401070',
        menu:'', //white, gray, inverted
        selectedMenuBackground:'#401070',
        ...
        RightBarColor:'#fff',
        LeftBarBackground:'rgba(0,0,0,0.2)',
        LeftBarColor:'#fff',
...
var people = [
    {oldname:'Maria.Studer', newname:'Grégoire Montangero', image:'http://cropserviceusingbasicweb.azurewebsites.net/Get.aspx?left_x=0.2186666666666667&top_y=0.0099129593810445&right_x=0.8346666666666667&bottom_y=0.7021276595744681&img=http://chablais-scope.ch/images/chablais-scope/Qui/Qui_Montangero.jpg'}, // logged in user
    {oldname:'Christoph.Enderli', newname:'Grégoire Praz', image:'http://cropserviceusingbasicweb.azurewebsites.net/Get.aspx?left_x=0.3875&top_y=0.07777777777&right_x=0.5875&bottom_y=0.59166666&img=http://www.rts.ch/2012/12/03/13/43/4478554.image'}, // first
    {oldname:'Aleksandar.Toskovic', newname:'Claude Oreiller', image:'http://cropserviceusingbasicweb.azurewebsites.net/Get.aspx?left_x=0.208&top_y=0.0692717584369449&right_x=0.7653333333333333&bottom_y=0.5843694493783304&img=http://www.chablais-scope.ch/images/chablais-scope/Qui/Qui_Oreiller.jpg'}, // major view
    {oldname:'Mickey.Mouse', newname:'Olivier Bournoud', image:'https://media.licdn.com/media/p/2/005/024/0ef/0f12dae.jpg'},
    {oldname:'Ralph.Keller', newname:'Reymond Favre', image:''},
    {oldname:'Christoph.Müller', newname:'Arnold Picon', image:''},
    {oldname:'Cyrill.Hagmann', newname:'Laurent Pittet', image:''},
...
var content = [
    {image:'http://cropserviceusingbasicweb.azurewebsites.net/Get.aspx?left_x=0&top_y=0&right_x=1&bottom_y=0.75&img=http://tpc.ch/site/images/tpc/Boutons/Bus.jpg', title:'Proin neque dui.', short:'Leo justo. Quis accumsan per porta hac. Porttitor iaculis viverra condimentum ridiculus nascetur Velit velit est euismod orci porta libero commodo dignissim nascetur vulputate.'},
    {image:'http://cropserviceusingbasicweb.azurewebsites.net/Get.aspx?left_x=0&top_y=0&right_x=1&bottom_y=0.75&img=http://tpc.ch/site/images/tpc/Boutons/Trains.jpg', title:'Etiam elementum quis enim', short:'Proin hendrerit, felis vel mattis blandit, urna massa porttitor ante, id aliquet massa urna eget nibh. Fusce at eleifend justo, at rutrum metus'},
    {image:'http://cropserviceusingbasicweb.azurewebsites.net/Get.aspx?left_x=0&top_y=0&right_x=1&bottom_y=0.75&img=http://tpc.ch/site/images/tpc/Boutons/Materiel_roulant.jpg', title:'Nunc et nisl nec leo commodo', short:'Aliquam bibendum rhoncus urna, vitae congue leo sodales sit amet. Integer rhoncus arcu eu lacus aliquam, sed tempor velit ornare'},
    {image:'http://cropserviceusingbasicweb.azurewebsites.net/Get.aspx?left_x=0&top_y=0&right_x=1&bottom_y=0.75&img=http://tpc.ch/site/images/tpc/Boutons/BVB.jpg', title:'Nam ut ipsum ac', short:'Integer pellentesque mattis tincidunt. Etiam venenatis lobortis lacus, accumsan auctor nisl pretium in. Aliquam porta nisl a vehicula ultrices.'},
    {image:'http://www.tpc.ch/site/images/tpc/Diaporamas/ASD_Stiffeler/images/ASD%206.jpg', title:'Praesent sed volutpat lacus', short:'Etiam a lacus vitae erat pretium consectetur. Donec ultricies sed ex in sagittis. Ut mattis sapien nec arcu lacinia, eu tristique elit placerat.'},
    {image:'http://www.tpc.ch/site/images/tpc/Diaporamas/ASD_Stiffeler/images/ASD%207.jpg', title:'Etiam convallis nibh', short:'Curabitur non ornare metus. Integer pharetra eget nulla quis fringilla. Nunc sagittis hendrerit ipsum'},
...
var portal = [
    {heroimage:'http://cropserviceusingbasicweb.azurewebsites.net/Get.aspx?left_x=0&top_y=0.45&right_x=1&bottom_y=0.9&img=http://www.tpc.ch/site/images/tpc/TransOrmonan/TransOrmonan-2.jpg'},
    {heroimage:'http://cropserviceusingbasicweb.azurewebsites.net/Get.aspx?left_x=0&top_y=0.3&right_x=1&bottom_y=0.95&img=http://www.tpc.ch/site/images/tpc/Offres/Dejeuners-ferroviaires.jpg'},    
    {heroimage:'http://cropserviceusingbasicweb.azurewebsites.net/Get.aspx?left_x=0&top_y=0.2&right_x=1&bottom_y=0.85&img=http://www.tpc.ch/site/images/tpc/Offres/Kuklos.jpg'},
    {heroimage:'http://cropserviceusingbasicweb.azurewebsites.net/Get.aspx?left_x=0&top_y=0.3&right_x=1&bottom_y=0.85&img=http://www.tpc.ch/site/images/tpc/Diaporamas/ASD_Stiffeler/images/ASD%203.jpg'},
            ];

//Use with care applied at end!
var words = [
    {old:'gmz',newword:'tpc'},
    {old:'migros',newword:'TPC'},
            ];
