...
function customize() {
    ...
    //replace words
    document.body.innerHTML = document.body.innerHTML.replace(/gmz/g, 'Planzer').replace(/GMZ/g, 'Planzer');
    document.body.innerHTML = document.body.innerHTML.replace(/migros/g, 'Planzer').replace(/GMZ/g, 'Planzer');
    ...
    document.body.innerHTML = document.body.innerHTML.replace(/vc0065\.virtualcorp\.ch\/snow\/_layouts\/15\/userphoto\.aspx\?accountName\=i\%3a0\%23\.w\%7cvirtualcorp\%5cmickey.mouse\&amp\;size\=M/g, 'media.licdn.com/mpr/mpr/shrinknp_400_400/AAEAAQAAAAAAAAY0AAAAJGNkNWEyMjU4LTdlM2ItNGFhYi04YmU5LTJjZTQ4YTQ4NGFmZA.jpg');
    document.body.innerHTML = document.body.innerHTML.replace(/Aleksandar.Toskovic/g, 'Jan Pfenninger');

    document.body.innerHTML = document.body.innerHTML.replace(/vc0065\.virtualcorp\.ch\/snow\/_layouts\/15\/userphoto\.aspx\?accountName\=i\%3a0\%23\.w\%7cvirtualcorp\%5caleksandar.toskovic\&amp\;size\=M/g, 'media.licdn.com/mpr/mpr/shrinknp_400_400/AAEAAQAAAAAAAAT0AAAAJGE1OWMwYTgzLTY0OTEtNGU3YS04ZTNlLWVhNjE3NzJhZGMxYQ.jpg');
    document.body.innerHTML = document.body.innerHTML.replace(/Mickey.Mouse/g, 'Severin Baer');

    document.body.innerHTML = document.body.innerHTML.replace(/vc0065\.virtualcorp\.ch\/snow\/_layouts\/15\/userphoto\.aspx\?accountName\=i\%3a0\%23\.w\%7cvirtualcorp\%5cmaria.studer\&amp\;size\=M/g, 'tse1.mm.bing.net/th?&amp;id=OIP.Mb31cedf17534037f30c963120cb49131o1&amp;w=140&amp;h=169&amp;c=0&amp;pid=1.9&amp;rs=0&amp;p=0&amp;r=0');
