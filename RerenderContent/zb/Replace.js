...
var look = {
    ...
    icon: 'http://www.zentralbahn.ch/favicon.ico',
    logo: 'http://cropserviceusingbasicweb.azurewebsites.net/Get.aspx?left_x=0.1&top_y=0.4&right_x=1&bottom_y=1&img=http://www.zentralbahn.ch/sites/all/themes/zentralbahn/images/logo.png',
    accents: '#e20018',
    menu: '', //active, inactive, inverted
    selectedMenuBackground: '#e1001a',
    selectedMenuColor: '#fff',
    passiveMenuBackground: '#f2f2f2',
    passiveMenuColor: '#ccc',
    menuSeparator: '#fff',
    RightBarBackground: '#e1001a', // also buttons
    RightBarColor: '#fff', // also button txt
    LeftBarBackground: '#e6e6e6',
    LeftBarColor: '#555e66',
    LeftBarChartColor: 'rgb(90,160,31)',
    StreamBackground: '#ccc',
    StreamAltBackground: '#ccc',
    StreamOverlayBackground: 'rgba(255,255,255,0.3)',
    StreamColor: '#555e66',
    Curve: 0
};
...
var images = [
    { image: 'http://zentralbahn.ch/sites/default/files/imagecache/frontpage_thumb/MM%20Zwischenbericht.jpg' },
    { image: 'https://www.zentralbahn.ch/sites/default/files/imagecache/gallery_thumb/gallery/_MG_0415.jpg' },
    { image: 'http://www.zentralbahn.ch/sites/default/files/imagecache/thumb/logo-jeder-tag-ist-oev-tag-2016_0.png' },
    { image: 'http://www.zentralbahn.ch/sites/default/files/imagecache/thumb/respekt2.jpg' },
    { image: 'http://www.zentralbahn.ch/sites/default/files/imagecache/thumb/IMG_1697.JPG' },
    { image: 'https://www.zentralbahn.ch/sites/default/files/imagecache/gallery_thumb/ZB_11-12-19_222_Ivan%20Buck_50x50.JPG' },
];
